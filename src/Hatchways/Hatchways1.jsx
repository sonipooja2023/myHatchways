...
//--------Approch 1--only one data will show at a time---
...
function toggleShowGrade(clickId){
   if(cardClickedId===clickId)
   {
    return setCardClicked("");
   }
   setCardClicked(clickId);
}
             ...
             <div className='grid-main'>
               <div className='grid-data'>
                ...
                <div className='expand-btn'>
                    <button id="toggle-icon" onClick={()=>toggleShowGrade(i.id)}>{i.id===cardClickedId ? isButtonExpanded(i.id) : "+"}</button>        
               </div>
               </div>
